...
public class GameManger {
    ...
    public QuestionResult processQuestionAnswer(boolean isCorrect) {
        if (difficulty == Difficulty.EASY) {
            // EASY GAME MODE RULES
            return switch (currentQuestionDifficulty) {
            ...
            return new QuestionResult(isCorrect, 0, 0, "Unknown game mode");
        }
    }
