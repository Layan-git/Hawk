...
public class ResourceLoader {
    ...
    /**
     * Get the absolute path to the CSV file.
     * This is for IDE development only. In JAR, use getResourceAsStream() instead.
     * 
     * @return Path to Questions.csv file
     */
    public static String getCSVPath() {
        // This method is for IDE development only
        // In production (JAR), use getResourceAsStream("/csvFiles/Questions.csv")
    ...
    public static String getHistoryCSVPath() {
        // This method is for IDE development only
        // In production (JAR), use getResourceAsStream("/csvFiles/History.csv")
